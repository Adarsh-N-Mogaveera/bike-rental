...
;
async function GET() {
    const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query('SELECT * FROM Customer');
...
async function POST(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query('INSERT INTO Customer (cust_id, name, phone, email, address) VALUES (?, ?, ?, ?, ?)', [
            cust_id,
            name,
            phone,
            email,
